...
function render(){
	...
	var label3 = new Label(rect3, "hello javasript",color3);

	var rect4 = new Rect(20,240,280,30);
	var button = new Button(rect4,"我是一个按钮", function(name){
		var randColor = new Color(Math.random(), Math.random(), Math.random(),1);
		Globle.changeBackgroundColor(name);
		// Globle.doSomething(randColor);
	});
